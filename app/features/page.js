    ...
    <div className={c.container}>
     <div className={c.contentContainer}>
        ...
        <div className={c.featuresColumn}>
          ...
          <p>Large updated country kitchen with center island, perfect for catering or any type of meal prep</p>
          <p>Hydraulic swim platform</p>
          <p>Multiple custom sun pads</p>
          <p>Multiple refrigerators and ice makers</p>
          <p>Upgraded bluetooth stereo with multiple amplifiers, multiple control heads and JL speakers</p>
        ...
        <div className={c.featuresColumn}>
          ...
          <p>1 Master-king bed with en-suite shower/jacuzzi tub with double sink vanity</p>
          ...
          <p>Day head</p>
          <p>Two sets of clothes washers and dryers. One set in the front of the boat for crew use, and one set in the back of the boat to service the 3 quest staterooms</p>
        </div>

        <div className={c.featuresColumn}>
          <h3>General Info</h3>
          <p>Beam: 20' 1'', Draft: 5'</p>
          <p>Length 80 ft. Overall length with hydraulic TNT platform 85 feet</p>
          <p>Displacement: 115,000 lb</p>
          <p>Fuel Tank: 1 x 2000 gallon Fresh Water: 1 x 400 gallon Black water: 1 x 200 gallon</p>
